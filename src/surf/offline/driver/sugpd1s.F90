...
USE YOMGPD1S , ONLY : GPD, GPD_SDP2, GPD_SDP3       ,&
            ...
            &VFCVL    ,VFCVH    ,VFCUR    ,VFIRFR ,VFTVL    ,VFTVH    ,&
            ...
            &VFLDEPTH ,VFLDEPTHF,VFCLAKE  ,VFCLAKEF, &!FLAKE 
            &VFCO2TYP,&
...
USE PTRGPD1S , ONLY :  MVFZ0F   ,MVFALBF  ,MVFITM   ,&
            ...
            &MVFLAIL  ,MVFBVOCLAIL  ,MVFLAIH  ,MVFBVOCLAIH  ,MVFCUR   ,&
            &MVFIRFR,MVFFWET  ,MVFAVGPAR, MVFISOP_EP,&
            ...
            &MVFLDEPTH,MVFLDEPTHF,MVFCLAKE ,MVFCLAKEF, &!FLAKE
            &MVFCO2TYP,&
...
!        G. Balsamo (ECMWF) add Irrigation
...
MVFCLAKEF=MVFCLAKE+1    ! FLAKE + Flood
MVFLDEPTH=MVFCLAKEF+1   ! FLAKE 
MVFLDEPTHF=MVFLDEPTH+1  ! FLAKE + Flood
MVFPGLOB=MVFLDEPTHF+1
...
VFLDEPTHF => GPD(:,MVFLDEPTHF,:) !FLAKE + FLood
...
!*       3.    Print final values.
  ...
  WRITE(UNIT=KULOUT,FMT=*) ' VFIRFR  =  ',VFIRFR
