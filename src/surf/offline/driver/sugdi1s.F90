...
USE YOMDPHY  , ONLY : NCSS, NPOI     ,NTILES ,NVHILO,NBLOCKS
...
USE YOMGDI1S , ONLY : GDI1S    ,GDIAUX1S ,&
            ...
            &D1STE    ,D1STRO   ,D1STSRO  ,D1STIRRFLX,  D1SMLT   ,&
            &D1SGWREC ,D1SGWCAP ,D1SDELAQ ,&
...
IMPLICIT NONE
INTEGER(KIND=JPIM) :: I1D,I1DVA,I2DVA,I3DVA,I3D,I4DVA,I5DVA, &
...
INTEGER(KIND=JPIM) :: M1STISRD,M1STISRU,M1STITRD,M1STITRU,M1STIH,&
     ...
     &  M1SLSRF,M1SCRF,M1SLSSF,M1SCSF,M1STE,M1STRO,M1STSRO,M1SMLT,M1STIRRFLX,&
     ...
     &  M1SRSOIL_STR,M1SRECO,M1SCO2FLUX,M1SCH4FLUX,M1SBVOCFLUX,M1SBVOCFLUXVT1,M1SBVOCFLUXVT2,&
     ...
     &  M1SCO2AIR,M1SGWREC,M1SGWCAP,M1SDELAQ
...
I1DVA=I1DVA+6+1+1 !CO2: 6, CH4: 1, BVOC: 1


I2DVA=6
I3DVA=10+1+1 ! instressed vegetation
I4DVA=6+1 !CO2: 6, RNOQ10: 1
I5DVA=2 !BVOC: two diagnostics
N2DDI=I5DVA*NVHILO+I4DVA*NVHILO+I3DVA*NTILES+I2DVA*NCSS+I1DVA

I3D=2

I1DAUX=NPOI
I1DVAAUX=23+7+5+2+1+3 ! +3: D1SGWREC, D1SGWCAP, D1SDELAQ
...
N2DDIAUX=(2*2+13*NVHILO)+I3DVAAUX*NTILES+I2DVAAUX*NCSS+I1DVAAUX+1

!*       2.  ALLOCATE TOTAL SIZE.
!            --------------------
ALLOCATE (GDI1S(NPROMA,N2DDI,I3D,NBLOCKS))
ALLOCATE (GDIAUX1S(NPROMA,N2DDIAUX,I3D,NBLOCKS))
GDI1S(:,:,:,:)=0._JPRB
GDIAUX1S(:,:,:,:)=0._JPRB
...
M1SBVOCFLUX=M1SCH4FLUX+1
M1SBVOCFLUXVT1=M1SBVOCFLUX+1
M1SBVOCFLUXVT2=M1SBVOCFLUXVT1+NVHILO

I2DDI=M1SBVOCFLUXVT2+NVHILO-1
...
D1SBVOCFLUX => GDI1S(:,M1SBVOCFLUX,1,:)
D1SAN2 => GDI1S(:,M1SAN,:,:)
D1SAG2 => GDI1S(:,M1SAG,:,:)
D1SRD2 => GDI1S(:,M1SRD,:,:)
...
D1SBVOCFLUX2 => GDI1S(:,M1SBVOCFLUX,:,:)

!BVOC flux per vegetation type
D1SBVOCST1 => GDI1S(:,M1SBVOCFLUXVT1:M1SBVOCFLUXVT1+NVHILO-1,1,:)
D1SBVOCST2 => GDI1S(:,M1SBVOCFLUXVT2:M1SBVOCFLUXVT2+NVHILO-1,1,:)
...
M1STIRRFLX=M1STSRO+1
D1STIRRFLX => GDIAUX1S(:,M1STIRRFLX,1,:)
D1STIRRFLX2 => GDIAUX1S(:,M1STIRRFLX,:,:)
M1SMLT=M1STIRRFLX+1
...
! Aquifer exchange diagnostics (LEGWRECHARGE): recharge down, capillary rise up,
! and the resulting storage change. Appended at the end of the aux chain so the
! existing indices do not shift.
M1SGWREC=M1SCO2AIR+1
D1SGWREC => GDIAUX1S(:,M1SGWREC,1,:)
D1SGWREC2 => GDIAUX1S(:,M1SGWREC,:,:)
M1SGWCAP=M1SGWREC+1
D1SGWCAP => GDIAUX1S(:,M1SGWCAP,1,:)
D1SGWCAP2 => GDIAUX1S(:,M1SGWCAP,:,:)
M1SDELAQ=M1SGWCAP+1
D1SDELAQ => GDIAUX1S(:,M1SDELAQ,1,:)
D1SDELAQ2 => GDIAUX1S(:,M1SDELAQ,:,:)
...
I2DDIAUX=M1SDELAQ   ! last aux index -- see the aquifer block above
