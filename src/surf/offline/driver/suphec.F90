...
USE YOMDPHY  , ONLY : NCSS     ,NTILES , NCSNEC
USE YOEPHY   , ONLY : RTHRFRTI, LEVGEN   ,LESSRO  , LEIRRIGATION ,LESN09   ,&
...
CALL SUSURF(KSW=NSW,KCSS=NCSS,KCWS=NCWS,KCSNEC=NCSNEC,KSIL=NSIL,KCOM=NCOM,KTILES=NTILES,KTSW=NTSW,KLWEMISS=NLWEMISS,&
    ...
    & LD_LEIRRIGATION=LEIRRIGATION,LD_LELAIV=LELAIV,LD_LECTESSEL=LECTESSEL,LD_LEAGS=LEAGS,&
    ...
    & YDSURF=YSURF,PRALFMINPSN=RALFMINPSN,PRCIMIN=RCIMIN, TMP_SURF=TMP_SURF)
