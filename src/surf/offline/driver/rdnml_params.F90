...
!    WRITE(*,*) "Reading global ags parameters from namelist..."
  ...
  SUBROUTINE RDNML_FLAKE(TMP_SURF)
    ...
    REAL(KIND=JPRD) :: RDEPTH_W_MIX_IW = 0.2_JPRD
    REAL(KIND=JPRD) :: TMNW_NDG_TIMESCL = 1800.0_JPRD
    REAL(KIND=JPRD) :: TMNW_NDG_RDSCL = 3.0_JPRD
    LOGICAL :: LFLAKE_BOTSED = .FALSE.
    REAL(KIND=JPRD) :: RDEPTH_BOTSED = 2.0_JPRD
    REAL(KIND=JPRD) :: RPHI_BOTSED_PR0 = 2.0_JPRD
...
!    WRITE(*,*) "Reading global flake parameters from namelist..."
    ...
    TMP_SURF%RDEPTH_W_MIX_IW  = RDEPTH_W_MIX_IW
    TMP_SURF%TMNW_NDG_TIMESCL = TMNW_NDG_TIMESCL
    TMP_SURF%TMNW_NDG_RDSCL   = TMNW_NDG_RDSCL
    TMP_SURF%LFLAKE_BOTSED    = LFLAKE_BOTSED
    TMP_SURF%RDEPTH_BOTSED    = RDEPTH_BOTSED
    TMP_SURF%RPHI_BOTSED_PR0  = RPHI_BOTSED_PR0
    ...
    WRITE(NULOUT,*) '   RDEPTH_W_MIX_IW        = ', RDEPTH_W_MIX_IW
    WRITE(NULOUT,*) '   TMNW_NDG_TIMESCL       = ', TMNW_NDG_TIMESCL
    WRITE(NULOUT,*) '   TMNW_NDG_RDSCL         = ', TMNW_NDG_RDSCL 
    WRITE(NULOUT,*) '   LFLAKE_BOTSED          = ', LFLAKE_BOTSED
    WRITE(NULOUT,*) '   RDEPTH_BOTSED          = ', RDEPTH_BOTSED
    WRITE(NULOUT,*) '   RPHI_BOTSED_PR0        = ', RPHI_BOTSED_PR0
