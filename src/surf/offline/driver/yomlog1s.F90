...
INTEGER(KIND=JPIM) :: NCHUNKTIME
INTEGER(KIND=JPIM) :: NIOBUF
...
! NCHUNKTIME I: INTEGER : RECORDS PER CHUNK ON THE NETCDF4 TIME AXIS:
!                         <0 AUTO-SIZE (DEFAULT), 0 LEGACY 1-RECORD CHUNKS, >0 FORCED
! NIOBUF   I : INTEGER : RECORDS HELD IN MEMORY BEFORE EACH OUTPUT WRITE:
!                         <0 AUTO = ONE TIME CHUNK (DEFAULT), 0 WRITE THROUGH, >0 FORCED
