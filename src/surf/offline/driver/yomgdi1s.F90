...
!     D1STIRRFLX:	IRRIGATION FLUX
!     D1SGWREC:	AQUIFER RECHARGE, SOIL -> WATER TABLE (LEGWRECHARGE)
!     D1SGWCAP:	CAPILLARY RISE, WATER TABLE -> SOIL (LEGWRECHARGE)
!     D1SDELAQ:	AQUIFER STORAGE CHANGE (LEGWRECHARGE)
!     D1SMLT:		SNOW MELT
...
REAL(KIND=JPRB),POINTER:: D1STIRRFLX(:,:)
REAL(KIND=JPRB),POINTER:: D1SGWREC(:,:)
REAL(KIND=JPRB),POINTER:: D1SGWCAP(:,:)
REAL(KIND=JPRB),POINTER:: D1SDELAQ(:,:)
...
REAL(KIND=JPRB),POINTER:: D1STIRRFLX2(:,:,:)
REAL(KIND=JPRB),POINTER:: D1SGWREC2(:,:,:)
REAL(KIND=JPRB),POINTER:: D1SGWCAP2(:,:,:)
REAL(KIND=JPRB),POINTER:: D1SDELAQ2(:,:,:)
...
INTEGER(KIND=JPIM) :: M1SGWREC, M1SGWCAP, M1SDELAQ
END MODULE YOMGDI1S
