SUBROUTINE SUSDP_DFLT    (YDSURF, KIDIA, KFDIA, PTVL, PTVH, PSLT, PSSDP2, PSSDP3, KLEVS3D)
...
CALL SUSDP_DFLT_CTL   (KIDIA, KFDIA, PTVL, PTVH, PSLT, KLEVS3D, PSSDP2, PSSDP3, YDSURF%YVEG, YDSURF%YSOIL, YDSURF%YAGS)
