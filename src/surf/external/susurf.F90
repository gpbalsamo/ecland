...
!     G. Balsamo   ECMWF   10-11-2025  Include irrigation
...
IF (PRESENT(PRCIMIN)) THEN
  CALL SUSURF_CTL(KSW,KCSS,KCWS,KCSNEC,KSIL,KCOM,KTILES,KTSW,KLWEMISS,&
   ...
   & PRLAIINT,PRSUN,PRCORIOI,PRPLRG, PNSNMLWS,&
   & PRVR0VT,PRVCMAX25,PRHUMREL,PRA1,PRB1,PRG0,PRGM25,PRE_VCMAX,PRE_JMAX,&
   & YDSURF%YDIM,YDSURF%YEXC,YDSURF%YCST,YDSURF%YRAD,YDSURF%YRDI,YDSURF%YLW,&
   & YDSURF%YSW,YDSURF%YSOIL,YDSURF%YVEG,YDSURF%YBVOC,YDSURF%YAGS,YDSURF%YAGF,YDSURF%YMLM,YDSURF%YFLAKE,&
   & YDSURF%YOCEAN_ML,YDSURF%YURB,PRALFMINPSN, PRCIMIN=PRCIMIN,TMP_SURF=TMP_SURF)
ELSE
  CALL SUSURF_CTL(KSW,KCSS,KCWS,KCSNEC,KSIL,KCOM,KTILES,KTSW,KLWEMISS,&
   & KBVOC_EMIS,KBVOC_DELTA_DAY_LAI,&
   & LD_LEFLAKE,LD_LEURBAN,LD_LEOCML,LD_LOCMLTKE,&
   ...
   & YDSURF%YDIM,YDSURF%YEXC,YDSURF%YCST,YDSURF%YRAD,YDSURF%YRDI,YDSURF%YLW,&
   & YDSURF%YSW,YDSURF%YSOIL,YDSURF%YVEG,YDSURF%YBVOC,YDSURF%YAGS,YDSURF%YAGF,YDSURF%YMLM,YDSURF%YFLAKE,&
   & YDSURF%YOCEAN_ML,YDSURF%YURB,PRALFMINPSN,TMP_SURF=TMP_SURF)
ENDIF
