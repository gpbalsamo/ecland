...
IF (LHOOK) CALL DR_HOOK('SURFTSTPSTL',0,ZHOOK_HANDLE)

IF(UBOUND(LDLAND,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: LDLAND TOO SHORT!')
ENDIF

IF(UBOUND(LDSICE,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: LDSICE TOO SHORT!')
ENDIF

IF(UBOUND(LDLICE,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: LDLICE TOO SHORT!')
ENDIF

IF(UBOUND(LDNH,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: LDNH TOO SHORT!')
ENDIF

IF(UBOUND(PSNM1M5,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: PSNM1M5 TOO SHORT!')
ENDIF

IF(UBOUND(PSNM1M5,2) < KLEVSN) THEN
  CALL ABORT_SURF('SURFTSTPSTL: SECOND DIMENSION OF PSNM1M5 TOO SHORT!')
ENDIF

IF(UBOUND(PTSNM1M5,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: PTSNM1M5 TOO SHORT!')
ENDIF

IF(UBOUND(PTSNM1M5,2) < KLEVSN) THEN
  CALL ABORT_SURF('SURFTSTPSTL: SECOND DIMENSION OF PTSNM1M5 TOO SHORT!')
ENDIF

IF(UBOUND(PRSNM1M,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: PRSNM1M TOO SHORT!')
ENDIF

IF(UBOUND(PRSNM1M,2) < KLEVSN) THEN
  CALL ABORT_SURF('SURFTSTPSTL: SECOND DIMENSION OF PRSNM1M TOO SHORT!')
ENDIF

IF(UBOUND(PWLM1M5,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: PWLM1M5 TOO SHORT!')
ENDIF

IF(UBOUND(PHLICEM1M5,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: PHLICEM1M5 TOO SHORT!')
ENDIF

IF(UBOUND(PAPRS5,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: PAPRS5 TOO SHORT!')
ENDIF

IF(UBOUND(PRSFC5,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: PRSFC5 TOO SHORT!')
ENDIF

IF(UBOUND(PRSFL5,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: PRSFL5 TOO SHORT!')
ENDIF

IF(UBOUND(PSLRFL5,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: PSLRFL5 TOO SHORT!')
ENDIF

IF(UBOUND(PSSFC5,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: PSSFC5 TOO SHORT!')
ENDIF

IF(UBOUND(PSSFL5,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: PSSFL5 TOO SHORT!')
ENDIF

IF(UBOUND(PCVL,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: PCVL TOO SHORT!')
ENDIF

IF(UBOUND(PCVH,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: PCVH TOO SHORT!')
ENDIF
...
IF(UBOUND(PCIL,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: PCIL TOO SHORT!')
ENDIF

IF(UBOUND(PWLMX5,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: PWLMX5 TOO SHORT!')
ENDIF

IF(UBOUND(PEVAPSNW5,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: PEVAPSNW5 TOO SHORT!')
ENDIF

IF(UBOUND(PTHKICE5,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: PTHKICE5 TOO SHORT!')
ENDIF

IF(UBOUND(PTSNE15,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: PTSNE15 TOO SHORT!')
ENDIF

IF(UBOUND(PTSNE15,2) < KLEVSN) THEN
  CALL ABORT_SURF('SURFTSTPSTL: SECOND DIMENSION OF PTSNE15 TOO SHORT!')
ENDIF

IF(UBOUND(PFRTI,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: FIRST DIMENSION OF PFRTI TOO SHORT!')
ENDIF

IF(UBOUND(PFRTI,2) < KTILES) THEN
  CALL ABORT_SURF('SURFTSTPSTL: SECOND DIMENSION OF PFRTI TOO SHORT!')
ENDIF

IF(UBOUND(PAHFSTI5,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: FIRST DIMENSION OF PAHFSTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PAHFSTI5,2) < KTILES) THEN
  CALL ABORT_SURF('SURFTSTPSTL: SECOND DIMENSION OF PAHFSTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PEVAPTI5,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: FIRST DIMENSION OF PEVAPTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PEVAPTI5,2) < KTILES) THEN
  CALL ABORT_SURF('SURFTSTPSTL: SECOND DIMENSION OF PEVAPTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PSSRFLTI5,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: FIRST DIMENSION OF PSSRFLTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PSSRFLTI5,2) < KTILES) THEN
  CALL ABORT_SURF('SURFTSTPSTL: SECOND DIMENSION OF PSSRFLTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PTSAM1M5,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: FIRST DIMENSION OF PTSAM1M5 TOO SHORT!')
ENDIF

IF(UBOUND(PTSAM1M5,2) < KLEVS) THEN
  CALL ABORT_SURF('SURFTSTPSTL: SECOND DIMENSION OF PTSAM1M5 TOO SHORT!')
ENDIF

IF(UBOUND(PTIAM1M5,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: FIRST DIMENSION OF PTIAM1M5 TOO SHORT!')
ENDIF

IF(UBOUND(PTIAM1M5,2) < KLEVS) THEN
  CALL ABORT_SURF('SURFTSTPSTL: SECOND DIMENSION OF PTIAM1M5 TOO SHORT!')
ENDIF

IF(UBOUND(PWSAM1M5,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: FIRST DIMENSION OF PWSAM1M5 TOO SHORT!')
ENDIF

IF(UBOUND(PWSAM1M5,2) < KLEVS) THEN
  CALL ABORT_SURF('SURFTSTPSTL: SECOND DIMENSION OF PWSAM1M5 TOO SHORT!')
ENDIF

IF(UBOUND(PTSAE15,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: FIRST DIMENSION OF PTSAE15 TOO SHORT!')
ENDIF

IF(UBOUND(PTSAE15,2) < KLEVS) THEN
  CALL ABORT_SURF('SURFTSTPSTL: SECOND DIMENSION OF PTSAE15 TOO SHORT!')
ENDIF

IF(UBOUND(PTIAE15,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: FIRST DIMENSION OF PTIAE15 TOO SHORT!')
ENDIF

IF(UBOUND(PTIAE15,2) < KLEVS) THEN
  CALL ABORT_SURF('SURFTSTPSTL: SECOND DIMENSION OF PTIAE15 TOO SHORT!')
ENDIF

IF(UBOUND(PSNM1M,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: PSNM1M TOO SHORT!')
ENDIF

IF(UBOUND(PSNM1M,2) < KLEVSN) THEN
  CALL ABORT_SURF('SURFTSTPSTL: SECOND DIMENSION OF PSNM1M TOO SHORT!')
ENDIF

IF(UBOUND(PTSNM1M,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: PTSNM1M TOO SHORT!')
ENDIF

IF(UBOUND(PTSNM1M,2) < KLEVSN) THEN
  CALL ABORT_SURF('SURFTSTPSTL: SECOND DIMENSION OF PTSNM1M TOO SHORT!')
ENDIF

IF(UBOUND(PWLM1M,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: PWLM1M TOO SHORT!')
ENDIF

IF(UBOUND(PAPRS,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: PAPRS TOO SHORT!')
ENDIF

IF(UBOUND(PRSFC,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: PRSFC TOO SHORT!')
ENDIF

IF(UBOUND(PRSFL,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: PRSFL TOO SHORT!')
ENDIF

IF(UBOUND(PSLRFL,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: PSLRFL TOO SHORT!')
ENDIF

IF(UBOUND(PSSFC,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: PSSFC TOO SHORT!')
ENDIF

IF(UBOUND(PSSFL,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: PSSFL TOO SHORT!')
ENDIF

IF(UBOUND(PEVAPSNW,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: PEVAPSNW TOO SHORT!')
ENDIF

IF(UBOUND(PTSNE1,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: PTSNE1 TOO SHORT!')
ENDIF

IF(UBOUND(PTSNE1,2) < KLEVSN) THEN
  CALL ABORT_SURF('SURFTSTPSTL: SECOND DIMENSION OF PTSNE1 TOO SHORT!')
ENDIF

IF(UBOUND(PAHFSTI,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: FIRST DIMENSION OF PAHFSTI TOO SHORT!')
ENDIF

IF(UBOUND(PAHFSTI,2) < KTILES) THEN
  CALL ABORT_SURF('SURFTSTPSTL: SECOND DIMENSION OF PAHFSTI TOO SHORT!')
ENDIF

IF(UBOUND(PEVAPTI,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: FIRST DIMENSION OF PEVAPTI TOO SHORT!')
ENDIF

IF(UBOUND(PEVAPTI,2) < KTILES) THEN
  CALL ABORT_SURF('SURFTSTPSTL: SECOND DIMENSION OF PEVAPTI TOO SHORT!')
ENDIF

IF(UBOUND(PSSRFLTI,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: FIRST DIMENSION OF PSSRFLTI TOO SHORT!')
ENDIF

IF(UBOUND(PSSRFLTI,2) < KTILES) THEN
  CALL ABORT_SURF('SURFTSTPSTL: SECOND DIMENSION OF PSSRFLTI TOO SHORT!')
ENDIF

IF(UBOUND(PTSAM1M,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: FIRST DIMENSION OF PTSAM1M TOO SHORT!')
ENDIF

IF(UBOUND(PTSAM1M,2) < KLEVS) THEN
  CALL ABORT_SURF('SURFTSTPSTL: SECOND DIMENSION OF PTSAM1M TOO SHORT!')
ENDIF

IF(UBOUND(PTIAM1M,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: FIRST DIMENSION OF PTIAM1M TOO SHORT!')
ENDIF

IF(UBOUND(PTIAM1M,2) < KLEVS) THEN
  CALL ABORT_SURF('SURFTSTPSTL: SECOND DIMENSION OF PTIAM1M TOO SHORT!')
ENDIF

IF(UBOUND(PWSAM1M,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: FIRST DIMENSION OF PWSAM1M TOO SHORT!')
ENDIF

IF(UBOUND(PWSAM1M,2) < KLEVS) THEN
  CALL ABORT_SURF('SURFTSTPSTL: SECOND DIMENSION OF PWSAM1M TOO SHORT!')
ENDIF

IF(UBOUND(PTSAE1,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: FIRST DIMENSION OF PTSAE1 TOO SHORT!')
ENDIF

IF(UBOUND(PTSAE1,2) < KLEVS) THEN
  CALL ABORT_SURF('SURFTSTPSTL: SECOND DIMENSION OF PTSAE1 TOO SHORT!')
ENDIF

IF(UBOUND(PTIAE1,1) < KLON) THEN
  CALL ABORT_SURF('SURFTSTPSTL: FIRST DIMENSION OF PTIAE1 TOO SHORT!')
ENDIF

IF(UBOUND(PTIAE1,2) < KLEVS) THEN
  CALL ABORT_SURF('SURFTSTPSTL: SECOND DIMENSION OF PTIAE1 TOO SHORT!')
ENDIF


CALL SURFTSTPSTL_CTL(KIDIA, KFDIA, KLON, KLEVS, KLEVSN, KTILES,&
 & PTSPHY , PFRTI,&
!-trajectory
 & PCIL, &
 & LDLAND  , LDSICE  , LDLICE, LDSI     , LDNH   , LDREGSF,&
 ...
 & PSSDP2  ,PSSDP3    ,&
 & LNEMOICETHK, PTHKICE5, &
 & YDSURF%YCST,YDSURF%YVEG,YDSURF%YSOIL,YDSURF%YFLAKE,YDSURF%YURB,&
!-TENDENCIES OUTPUT
 & PTSNE15 , PTSAE15  , PTIAE15  ,&
!-perturbations
 & PAHFSTI , PEVAPTI  , PSSRFLTI ,&
...
IF (LHOOK) CALL DR_HOOK('SURFTSTPSTL',1,ZHOOK_HANDLE)
