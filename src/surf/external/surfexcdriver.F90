SUBROUTINE SURFEXCDRIVER(YDSURF &
...
REAL(KIND=JPRB)   ,INTENT(OUT)   :: PBVOCFLUX(KLON,YDSURF%YBVOC%NEMIS_BVOC)
...
CALL SURFEXCDRIVER_CTL( &
 ...
 & , PRPLRG &
 & , LSICOUP, LDSICE, LBLEND &
 & , YDSURF%YCST, YDSURF%YEXC, YDSURF%YVEG, YDSURF%YBVOC &
 & , YDSURF%YAGS, YDSURF%YAGF, YDSURF%YSOIL, YDSURF%YFLAKE, YDSURF%YURB &
 & )
