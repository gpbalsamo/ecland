...
USE ABORT_SURF_MOD
USE SURFRAD_CTL_MOD, ONLY: SURFRAD_CTL
...
! REAL(KIND=JPRB)   ,INTENT(IN)    :: PALCOEFF(KLON,:)
...
CALL SURFRAD_CTL (KDD,KMM,KMON,KSECO,&
 ...
 & PWS1,KSOTY,PFRTI,PHLICE,PTLICE,& 
 & PSSDP3,& 
 & YDSURF%YCST,YDSURF%YLW,YDSURF%YSW,YDSURF%YRAD,YDSURF%YRDI,YDSURF%YSOIL,YDSURF%YFLAKE,&
 & YDSURF%YURB,PALBD,PALBP,PALB,&
 & PSPECTRALEMISS,PEMIT,&
 & PALBTI,PCCNL,PCCNO,&
 & LNEMOLIMALB,LESNICE)
