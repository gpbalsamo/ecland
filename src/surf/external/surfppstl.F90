...
!  SURFPPSTL is called by VDFMAINS
...
!  P10NU5      PU10M         U-COMPONENT NEUTRAL WIND AT 10 M          m/s
!  P10NV5      PV10M         V-COMPONENT NEUTRAL WIND AT 10 M          m/s
...
IF (LHOOK) CALL DR_HOOK('SURFPPSTL',0,ZHOOK_HANDLE)

IF(UBOUND(PFRTI,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL:: FIRST DIMENSION OF PFRTI TOO SHORT!')
ENDIF

IF(UBOUND(PFRTI,2) < KTILES) THEN
  CALL ABORT_SURF('SURFPPSTL:: SECOND DIMENSION OF PFRTI TOO SHORT!')
ENDIF

IF(UBOUND(PTSKTIP15,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL:: FIRST DIMENSION OF PTSKTIP15 TOO SHORT!')
ENDIF

IF(UBOUND(PTSKTIP15,2) < KTILES) THEN
  CALL ABORT_SURF('SURFPPSTL:: SECOND DIMENSION OF PTSKTIP15 TOO SHORT!')
ENDIF

IF(UBOUND(PAHFLTI5,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL:: FIRST DIMENSION OF PAHFLTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PAHFLTI5,2) < KTILES) THEN
  CALL ABORT_SURF('SURFPPSTL:: SECOND DIMENSION OF PAHFLTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PG0TI5,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL:: FIRST DIMENSION OF PG0TI5 TOO SHORT!')
ENDIF

IF(UBOUND(PG0TI5,2) < KTILES) THEN
  CALL ABORT_SURF('SURFPPSTL:: SECOND DIMENSION OF PG0TI5 TOO SHORT!')
ENDIF

IF(UBOUND(PSTRTULEV5,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL: PSTRTULEV5 TOO SHORT!')
ENDIF

IF(UBOUND(PSTRTVLEV5,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL: PSTRTVLEV5 TOO SHORT!')
ENDIF

IF(UBOUND(PTSKM1M5,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL: PTSKM1M5 TOO SHORT!')
ENDIF

IF(UBOUND(PUMLEV5,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL: PUMLEV5 TOO SHORT!')
ENDIF

IF(UBOUND(PVMLEV5,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL: PVMLEV5 TOO SHORT!')
ENDIF

IF(UBOUND(PQMLEV5,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL: PQMLEV5 TOO SHORT!')
ENDIF

IF(UBOUND(PGEOMLEV5,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL: PGEOMLEV5 TOO SHORT!')
ENDIF

IF(UBOUND(PCPTSPP5,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL: PCPTSPP5 TOO SHORT!')
ENDIF

IF(UBOUND(PCPTGZLEV5,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL: PCPTGZLEV5 TOO SHORT!')
ENDIF

IF(UBOUND(PAPHMS5,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL: PAPHMS5 TOO SHORT!')
ENDIF

IF(UBOUND(PZ0MW5,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL: PZ0MW5 TOO SHORT!')
ENDIF

IF(UBOUND(PZ0HW5,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL: PZ0HW5 TOO SHORT!')
ENDIF

IF(UBOUND(PZ0QW5,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL: PZ0QW5 TOO SHORT!')
ENDIF

IF(UBOUND(PQSAPP5,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL: PQSAPP5 TOO SHORT!')
ENDIF

IF(UBOUND(PBUOM5,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL: PBUOM5 TOO SHORT!')
ENDIF

IF(UBOUND(PAHFSTI5,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL:: FIRST DIMENSION OF PAHFSTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PAHFSTI5,2) < KTILES) THEN
  CALL ABORT_SURF('SURFPPSTL:: SECOND DIMENSION OF PAHFSTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PEVAPTI5,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL:: FIRST DIMENSION OF PEVAPTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PEVAPTI5,2) < KTILES) THEN
  CALL ABORT_SURF('SURFPPSTL:: SECOND DIMENSION OF PEVAPTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PTSKE15,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL: PTSKE15 TOO SHORT!')
ENDIF

IF(UBOUND(PDIFTSLEV5,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL: PDIFTSLEV5 TOO SHORT!')
ENDIF

IF(UBOUND(PDIFTQLEV5,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL: PDIFTQLEV5 TOO SHORT!')
ENDIF

IF(UBOUND(PUSTRTI5,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL:: FIRST DIMENSION OF PUSTRTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PUSTRTI5,2) < KTILES) THEN
  CALL ABORT_SURF('SURFPPSTL:: SECOND DIMENSION OF PUSTRTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PVSTRTI5,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL:: FIRST DIMENSION OF PVSTRTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PVSTRTI5,2) < KTILES) THEN
  CALL ABORT_SURF('SURFPPSTL:: SECOND DIMENSION OF PVSTRTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PTSKTI5,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL:: FIRST DIMENSION OF PTSKTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PTSKTI5,2) < KTILES) THEN
  CALL ABORT_SURF('SURFPPSTL:: SECOND DIMENSION OF PTSKTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PZ0MTIW5,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL:: FIRST DIMENSION OF PZ0MTIW5 TOO SHORT!')
ENDIF

IF(UBOUND(PZ0MTIW5,2) < KTILES) THEN
  CALL ABORT_SURF('SURFPPSTL:: SECOND DIMENSION OF PZ0MTIW5 TOO SHORT!')
ENDIF

IF(UBOUND(PZ0HTIW5,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL:: FIRST DIMENSION OF PZ0HTIW5 TOO SHORT!')
ENDIF

IF(UBOUND(PZ0HTIW5,2) < KTILES) THEN
  CALL ABORT_SURF('SURFPPSTL:: SECOND DIMENSION OF PZ0HTIW5 TOO SHORT!')
ENDIF

IF(UBOUND(PZ0QTIW5,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL:: FIRST DIMENSION OF PZ0QTIW5 TOO SHORT!')
ENDIF

IF(UBOUND(PZ0QTIW5,2) < KTILES) THEN
  CALL ABORT_SURF('SURFPPSTL:: SECOND DIMENSION OF PZ0QTIW5 TOO SHORT!')
ENDIF

IF(UBOUND(PQSAPPTI5,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL:: FIRST DIMENSION OF PQSAPPTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PQSAPPTI5,2) < KTILES) THEN
  CALL ABORT_SURF('SURFPPSTL:: SECOND DIMENSION OF PQSAPPTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PCPTSPPTI5,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL:: FIRST DIMENSION OF PCPTSPPTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PCPTSPPTI5,2) < KTILES) THEN
  CALL ABORT_SURF('SURFPPSTL:: SECOND DIMENSION OF PCPTSPPTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PBUOMTI5,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL:: FIRST DIMENSION OF PBUOMTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PBUOMTI5,2) < KTILES) THEN
  CALL ABORT_SURF('SURFPPSTL:: SECOND DIMENSION OF PBUOMTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PU10M5,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL: PU10M5 TOO SHORT!')
ENDIF

IF(UBOUND(PV10M5,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL: PV10M5 TOO SHORT!')
ENDIF

IF(UBOUND(PT2M5,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL: PT2M5 TOO SHORT!')
ENDIF

IF(UBOUND(PD2M5,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL: PD2M5 TOO SHORT!')
ENDIF

IF(UBOUND(PQ2M5,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL: PQ2M5 TOO SHORT!')
ENDIF

IF(UBOUND(P10NU5,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL: P10NU5 TOO SHORT!')
ENDIF

IF(UBOUND(P10NV5,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL: P10NV5 TOO SHORT!')
ENDIF

IF(UBOUND(PTSKTIP1,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL:: FIRST DIMENSION OF PTSKTIP1 TOO SHORT!')
ENDIF

IF(UBOUND(PTSKTIP1,2) < KTILES) THEN
  CALL ABORT_SURF('SURFPPSTL:: SECOND DIMENSION OF PTSKTIP1 TOO SHORT!')
ENDIF

IF(UBOUND(PAHFLTI,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL:: FIRST DIMENSION OF PAHFLTI TOO SHORT!')
ENDIF

IF(UBOUND(PAHFLTI,2) < KTILES) THEN
  CALL ABORT_SURF('SURFPPSTL:: SECOND DIMENSION OF PAHFLTI TOO SHORT!')
ENDIF

IF(UBOUND(PG0TI,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL:: FIRST DIMENSION OF PG0TI TOO SHORT!')
ENDIF

IF(UBOUND(PG0TI,2) < KTILES) THEN
  CALL ABORT_SURF('SURFPPSTL:: SECOND DIMENSION OF PG0TI TOO SHORT!')
ENDIF

IF(UBOUND(PZ0MTIW,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL:: FIRST DIMENSION OF PZ0MTIW TOO SHORT!')
ENDIF

IF(UBOUND(PZ0MTIW,2) < KTILES) THEN
  CALL ABORT_SURF('SURFPPSTL:: SECOND DIMENSION OF PZ0MTIW TOO SHORT!')
ENDIF

IF(UBOUND(PZ0HTIW,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL:: FIRST DIMENSION OF PZ0HTIW TOO SHORT!')
ENDIF

IF(UBOUND(PZ0HTIW,2) < KTILES) THEN
  CALL ABORT_SURF('SURFPPSTL:: SECOND DIMENSION OF PZ0HTIW TOO SHORT!')
ENDIF

IF(UBOUND(PZ0QTIW,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL:: FIRST DIMENSION OF PZ0QTIW TOO SHORT!')
ENDIF

IF(UBOUND(PZ0QTIW,2) < KTILES) THEN
  CALL ABORT_SURF('SURFPPSTL:: SECOND DIMENSION OF PZ0QTIW TOO SHORT!')
ENDIF

IF(UBOUND(PQSAPPTI,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL:: FIRST DIMENSION OF PQSAPPTI TOO SHORT!')
ENDIF

IF(UBOUND(PQSAPPTI,2) < KTILES) THEN
  CALL ABORT_SURF('SURFPPSTL:: SECOND DIMENSION OF PQSAPPTI TOO SHORT!')
ENDIF

IF(UBOUND(PCPTSPPTI,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL:: FIRST DIMENSION OF PCPTSPPTI TOO SHORT!')
ENDIF

IF(UBOUND(PCPTSPPTI,2) < KTILES) THEN
  CALL ABORT_SURF('SURFPPSTL:: SECOND DIMENSION OF PCPTSPPTI TOO SHORT!')
ENDIF

IF(UBOUND(PBUOMTI,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL:: FIRST DIMENSION OF PBUOMTI TOO SHORT!')
ENDIF

IF(UBOUND(PBUOMTI,2) < KTILES) THEN
  CALL ABORT_SURF('SURFPPSTL:: SECOND DIMENSION OF PBUOMTI TOO SHORT!')
ENDIF


IF(UBOUND(PSTRTULEV,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL: PSTRTULEV TOO SHORT!')
ENDIF

IF(UBOUND(PSTRTVLEV,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL: PSTRTVLEV TOO SHORT!')
ENDIF

IF(UBOUND(PTSKM1M,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL: PTSKM1M TOO SHORT!')
ENDIF

IF(UBOUND(PUMLEV,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL: PUMLEV TOO SHORT!')
ENDIF

IF(UBOUND(PVMLEV,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL: PVMLEV TOO SHORT!')
ENDIF

IF(UBOUND(PQMLEV,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL: PQMLEV TOO SHORT!')
ENDIF

IF(UBOUND(PGEOMLEV,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL: PGEOMLEV TOO SHORT!')
ENDIF

IF(UBOUND(PCPTSPP,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL: PCPTSPP TOO SHORT!')
ENDIF

IF(UBOUND(PCPTGZLEV,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL: PCPTGZLEV TOO SHORT!')
ENDIF

IF(UBOUND(PAPHMS,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL: PAPHMS TOO SHORT!')
ENDIF

IF(UBOUND(PZ0MW,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL: PZ0MW TOO SHORT!')
ENDIF

IF(UBOUND(PZ0HW,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL: PZ0HW TOO SHORT!')
ENDIF

IF(UBOUND(PZ0QW,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL: PZ0QW TOO SHORT!')
ENDIF

IF(UBOUND(PQSAPP,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL: PQSAPP TOO SHORT!')
ENDIF

IF(UBOUND(PBUOM,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL: PBUOM TOO SHORT!')
ENDIF

IF(UBOUND(PAHFSTI,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL:: FIRST DIMENSION OF PAHFSTI TOO SHORT!')
ENDIF

IF(UBOUND(PAHFSTI,2) < KTILES) THEN
  CALL ABORT_SURF('SURFPPSTL:: SECOND DIMENSION OF PAHFSTI TOO SHORT!')
ENDIF

IF(UBOUND(PEVAPTI,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL:: FIRST DIMENSION OF PEVAPTI TOO SHORT!')
ENDIF

IF(UBOUND(PEVAPTI,2) < KTILES) THEN
  CALL ABORT_SURF('SURFPPSTL:: SECOND DIMENSION OF PEVAPTI TOO SHORT!')
ENDIF

IF(UBOUND(PTSKE1,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL: PTSKE1 TOO SHORT!')
ENDIF

IF(UBOUND(PDIFTSLEV,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL: PDIFTSLEV TOO SHORT!')
ENDIF

IF(UBOUND(PDIFTQLEV,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL: PDIFTQLEV TOO SHORT!')
ENDIF

IF(UBOUND(PUSTRTI,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL:: FIRST DIMENSION OF PUSTRTI TOO SHORT!')
ENDIF

IF(UBOUND(PUSTRTI,2) < KTILES) THEN
  CALL ABORT_SURF('SURFPPSTL:: SECOND DIMENSION OF PUSTRTI TOO SHORT!')
ENDIF

IF(UBOUND(PVSTRTI,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL:: FIRST DIMENSION OF PVSTRTI TOO SHORT!')
ENDIF

IF(UBOUND(PVSTRTI,2) < KTILES) THEN
  CALL ABORT_SURF('SURFPPSTL:: SECOND DIMENSION OF PVSTRTI TOO SHORT!')
ENDIF

IF(UBOUND(PTSKTI,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL:: FIRST DIMENSION OF PTSKTI TOO SHORT!')
ENDIF

IF(UBOUND(PTSKTI,2) < KTILES) THEN
  CALL ABORT_SURF('SURFPPSTL:: SECOND DIMENSION OF PTSKTI TOO SHORT!')
ENDIF

IF(UBOUND(PU10M,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL: PU10M TOO SHORT!')
ENDIF

IF(UBOUND(PV10M,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL: PV10M TOO SHORT!')
ENDIF

IF(UBOUND(PT2M,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL: PT2M TOO SHORT!')
ENDIF

IF(UBOUND(PD2M,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL: PD2M TOO SHORT!')
ENDIF

IF(UBOUND(PQ2M,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL: PQ2M TOO SHORT!')
ENDIF

IF(UBOUND(P10NU,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL: P10NU TOO SHORT!')
ENDIF

IF(UBOUND(P10NV,1) < KLON) THEN
  CALL ABORT_SURF('SURFPPSTL: P10NV TOO SHORT!')
ENDIF

CALL SURFPPSTL_CTL( KIDIA,KFDIA,KLON,KTILES,LDPPCFLS &
 & , PTSTEP &
! input - trajectory
 & , PFRTI, PTSKTIP15, PAHFLTI5, PG0TI5   , PSTRTULEV5, PSTRTVLEV5 , PTSKM1M5 &
 & , PUMLEV5, PVMLEV5, PQMLEV5 , PGEOMLEV5, PCPTSPP5  , PCPTGZLEV5 &
...
IF (LHOOK) CALL DR_HOOK('SURFPPSTL',1,ZHOOK_HANDLE)
