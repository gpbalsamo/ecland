...
USE ABORT_SURF_MOD
USE SURFBC_CTL_MOD, ONLY : SURFBC_CTL
!endif INTERFACE
...
CALL SURFBC_CTL   (KIDIA,KFDIA,KLON,KTILES,KLEVSN,&
 ...
 & PLSM   ,PCI    ,PCIL,PCLAKE ,PHLICE, PGEMU  ,PSNM1M ,PWLM1M,PRSNM1M,&  
 & LESNICE, &
 & LDLAND ,LDSICE ,LDLICE, LDLAKE ,LDNH   ,LDOCN_KPP,&
 & KTVL   ,KCO2TYP, KTVH   ,KSOTY  ,&
 & PCVL   ,PCVH   ,PCUR, PLAIL  , PLAIH ,  PLAILP, PLAIHP, PAVGPAR,& 
 & PWLMX  ,PFRTI, PCSN, PSSDP2, &
 & YDSURF%YSOIL, YDSURF%YVEG, YDSURF%YFLAKE, YDSURF%YURB, YDSURF%YOCEAN_ML)
