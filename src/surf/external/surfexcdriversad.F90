...
IF (LHOOK) CALL DR_HOOK('SURFEXCDRIVERSAD',0,ZHOOK_HANDLE)

IF(UBOUND(KTVL,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD: KTVL TOO SHORT!')
ENDIF

IF(UBOUND(KTVH,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD: KTVH TOO SHORT!')
ENDIF
...
IF(UBOUND(PUMLEV5,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD: PUMLEV5 TOO SHORT!')
ENDIF

IF(UBOUND(PVMLEV5,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD: PVMLEV5 TOO SHORT!')
ENDIF

IF(UBOUND(PTMLEV5,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD: PTMLEV5 TOO SHORT!')
ENDIF

IF(UBOUND(PQMLEV5,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD: PQMLEV5 TOO SHORT!')
ENDIF

IF(UBOUND(PAPHMS5,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD: PAPHMS5 TOO SHORT!')
ENDIF

IF(UBOUND(PGEOMLEV5,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD: PGEOMLEV5 TOO SHORT!')
ENDIF

IF(UBOUND(PCPTGZLEV5,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD: PCPTGZLEV5 TOO SHORT!')
ENDIF

IF(UBOUND(PSST,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD: PSST TOO SHORT!')
ENDIF

IF(UBOUND(PTSKM1M5,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD: PTSKM1M5 TOO SHORT!')
ENDIF

IF(UBOUND(PCHAR,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD: PCHAR TOO SHORT!')
ENDIF

IF(UBOUND(PSSRFL5,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD: PSSRFL5 TOO SHORT!')
ENDIF

IF(UBOUND(PTICE5,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD: PTICE5 TOO SHORT!')
ENDIF

IF(UBOUND(PTSNOW5,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD: PTSNOW5 TOO SHORT!')
ENDIF
...
IF(UBOUND(PTSAM1M5,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: FIRST DIMENSION OF PTSAM1M5 TOO SHORT!')
ENDIF

IF(UBOUND(PTSAM1M5,2) < KLEVS) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: SECOND DIMENSION OF PTSAM1M5 TOO SHORT!')
ENDIF

IF(UBOUND(PWSAM1M5,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: FIRST DIMENSION OF PWSAM1M5 TOO SHORT!')
ENDIF

IF(UBOUND(PWSAM1M5,2) < KLEVS) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: SECOND DIMENSION OF PWSAM1M5 TOO SHORT!')
ENDIF

IF(UBOUND(KSOTY,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: FIRST DIMENSION OF KSOTY TOO SHORT!')
ENDIF

IF(UBOUND(PFRTI,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: FIRST DIMENSION OF PFRTI TOO SHORT!')
ENDIF

IF(UBOUND(PFRTI,2) < KTILES) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: SECOND DIMENSION OF PFRTI TOO SHORT!')
ENDIF

IF(UBOUND(PALBTI5,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: FIRST DIMENSION OF PALBTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PALBTI5,2) < KTILES) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: SECOND DIMENSION OF PALBTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PUSTRTI5,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: FIRST DIMENSION OF PUSTRTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PUSTRTI5,2) < KTILES) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: SECOND DIMENSION OF PUSTRTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PVSTRTI5,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: FIRST DIMENSION OF PVSTRTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PVSTRTI5,2) < KTILES) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: SECOND DIMENSION OF PVSTRTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PAHFSTI5,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: FIRST DIMENSION OF PAHFSTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PAHFSTI5,2) < KTILES) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: SECOND DIMENSION OF PAHFSTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PEVAPTI5,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: FIRST DIMENSION OF PEVAPTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PEVAPTI5,2) < KTILES) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: SECOND DIMENSION OF PEVAPTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PTSKTI5,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: FIRST DIMENSION OF PTSKTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PTSKTI5,2) < KTILES) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: SECOND DIMENSION OF PTSKTI5 TOO SHORT!')
ENDIF
...
IF(UBOUND(PZ0M5,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD: PZ0M5 TOO SHORT!')
ENDIF

IF(UBOUND(PZ0H5,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD: PZ0H5 TOO SHORT!')
ENDIF

IF(UBOUND(PSSRFLTI5,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: FIRST DIMENSION OF PSSRFLTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PSSRFLTI5,2) < KTILES) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD::SECOND DIMENSION OF PSSRFLTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PQSTI5,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: FIRST DIMENSION OF PQSTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PQSTI5,2) < KTILES) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: SECOND DIMENSION OF PQSTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PDQSTI5,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: FIRST DIMENSION OF PDQSTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PDQSTI5,2) < KTILES) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: SECOND DIMENSION OF PDQSTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PCPTSTI5,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: FIRST DIMENSION OF PCPTSTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PCPTSTI5,2) < KTILES) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: SECOND DIMENSION OF PCPTSTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PCFHTI5,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: FIRST DIMENSION OF PCFHTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PCFHTI5,2) < KTILES) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: SECOND DIMENSION OF PCFHTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PCFQTI5,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: FIRST DIMENSION OF PCFQTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PCFQTI5,2) < KTILES) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: SECOND DIMENSION OF PCFQTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PCSATTI5,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: FIRST DIMENSION OF PCSATTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PCSATTI5,2) < KTILES) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: SECOND DIMENSION OF PCSATTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PCAIRTI5,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: FIRST DIMENSION OF PCAIRTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PCAIRTI5,2) < KTILES) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: SECOND DIMENSION OF PCAIRTI5 TOO SHORT!')
ENDIF

IF(UBOUND(PCFMLEV5,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD: PCFMLEV5 TOO SHORT!')
ENDIF

IF(UBOUND(PEVAPSNW5,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD: PEVAPSNW5 TOO SHORT!')
ENDIF

IF(UBOUND(PZ0MW5,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD: PZ0MW5 TOO SHORT!')
ENDIF

IF(UBOUND(PZ0HW5,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD: PZ0HW5 TOO SHORT!')
ENDIF

IF(UBOUND(PZ0QW5,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD: PZ0QW5 TOO SHORT!')
ENDIF

IF(UBOUND(PCPTSPP5,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD: PCPTSPP5 TOO SHORT!')
ENDIF

IF(UBOUND(PQSAPP5,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD: PQSAPP5 TOO SHORT!')
ENDIF

IF(UBOUND(PBUOMPP5,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD: PBUOMPP5 TOO SHORT!')
ENDIF

IF(UBOUND(PUMLEV,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD: PUMLEV TOO SHORT!')
ENDIF

IF(UBOUND(PVMLEV,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD: PVMLEV TOO SHORT!')
ENDIF

IF(UBOUND(PTMLEV,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD: PTMLEV TOO SHORT!')
ENDIF

IF(UBOUND(PQMLEV,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD: PQMLEV TOO SHORT!')
ENDIF

IF(UBOUND(PAPHMS,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD: PAPHMS TOO SHORT!')
ENDIF

IF(UBOUND(PGEOMLEV,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD: PGEOMLEV TOO SHORT!')
ENDIF

IF(UBOUND(PCPTGZLEV,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD: PCPTGZLEV TOO SHORT!')
ENDIF

IF(UBOUND(PTSKM1M,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD: PTSKM1M TOO SHORT!')
ENDIF

IF(UBOUND(PSSRFL,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD: PSSRFL TOO SHORT!')
ENDIF
...
IF(UBOUND(PTSAM1M,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: FIRST DIMENSION OF PTSAM1M TOO SHORT!')
ENDIF

IF(UBOUND(PTSAM1M,2) < KLEVS) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: SECOND DIMENSION OF PTSAM1M TOO SHORT!')
ENDIF

IF(UBOUND(PWSAM1M,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: FIRST DIMENSION OF PWSAM1M TOO SHORT!')
ENDIF

IF(UBOUND(PWSAM1M,2) < KLEVS) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: SECOND DIMENSION OF PWSAM1M TOO SHORT!')
ENDIF

IF(UBOUND(PALBTI,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: FIRST DIMENSION OF PALBTI TOO SHORT!')
ENDIF

IF(UBOUND(PALBTI,2) < KTILES) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: SECOND DIMENSION OF PALBTI TOO SHORT!')
ENDIF

IF(UBOUND(PUSTRTI,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: FIRST DIMENSION OF PUSTRTI TOO SHORT!')
ENDIF

IF(UBOUND(PUSTRTI,2) < KTILES) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: SECOND DIMENSION OF PUSTRTI TOO SHORT!')
ENDIF

IF(UBOUND(PVSTRTI,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: FIRST DIMENSION OF PVSTRTI TOO SHORT!')
ENDIF

IF(UBOUND(PVSTRTI,2) < KTILES) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: SECOND DIMENSION OF PVSTRTI TOO SHORT!')
ENDIF

IF(UBOUND(PAHFSTI,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: FIRST DIMENSION OF PAHFSTI TOO SHORT!')
ENDIF

IF(UBOUND(PAHFSTI,2) < KTILES) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: SECOND DIMENSION OF PAHFSTI TOO SHORT!')
ENDIF

IF(UBOUND(PEVAPTI,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: FIRST DIMENSION OF PEVAPTI TOO SHORT!')
ENDIF

IF(UBOUND(PEVAPTI,2) < KTILES) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: SECOND DIMENSION OF PEVAPTI TOO SHORT!')
ENDIF

IF(UBOUND(PTSKTI,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: FIRST DIMENSION OF PTSKTI TOO SHORT!')
ENDIF

IF(UBOUND(PTSKTI,2) < KTILES) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: SECOND DIMENSION OF PTSKTI TOO SHORT!')
ENDIF

IF(UBOUND(PZ0M,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD: PZ0M TOO SHORT!')
ENDIF

IF(UBOUND(PZ0H,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD: PZ0H TOO SHORT!')
ENDIF

IF(UBOUND(PSSRFLTI,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: FIRST DIMENSION OF PSSRFLTI TOO SHORT!')
ENDIF

IF(UBOUND(PSSRFLTI,2) < KTILES) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: SECOND DIMENSION OF PSSRFLTI TOO SHORT!')
ENDIF

IF(UBOUND(PQSTI,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: FIRST DIMENSION OF PQSTI TOO SHORT!')
ENDIF

IF(UBOUND(PQSTI,2) < KTILES) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: SECOND DIMENSION OF PQSTI TOO SHORT!')
ENDIF

IF(UBOUND(PDQSTI,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: FIRST DIMENSION OF PDQSTI TOO SHORT!')
ENDIF

IF(UBOUND(PDQSTI,2) < KTILES) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: SECOND DIMENSION OF PDQSTI TOO SHORT!')
ENDIF

IF(UBOUND(PCPTSTI,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: FIRST DIMENSION OF PCPTSTI TOO SHORT!')
ENDIF

IF(UBOUND(PCPTSTI,2) < KTILES) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: SECOND DIMENSION OF PCPTSTI TOO SHORT!')
ENDIF

IF(UBOUND(PCFHTI,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: FIRST DIMENSION OF PCFHTI TOO SHORT!')
ENDIF

IF(UBOUND(PCFHTI,2) < KTILES) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: SECOND DIMENSION OF PCFHTI TOO SHORT!')
ENDIF

IF(UBOUND(PCFQTI,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: FIRST DIMENSION OF PCFQTI TOO SHORT!')
ENDIF

IF(UBOUND(PCFQTI,2) < KTILES) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: SECOND DIMENSION OF PCFQTI TOO SHORT!')
ENDIF

IF(UBOUND(PCSATTI,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: FIRST DIMENSION OF PCSATTI TOO SHORT!')
ENDIF

IF(UBOUND(PCSATTI,2) < KTILES) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: SECOND DIMENSION OF PCSATTI TOO SHORT!')
ENDIF

IF(UBOUND(PCAIRTI,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: FIRST DIMENSION OF PCAIRTI TOO SHORT!')
ENDIF

IF(UBOUND(PCAIRTI,2) < KTILES) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD:: SECOND DIMENSION OF PCAIRTI TOO SHORT!')
ENDIF

IF(UBOUND(PCFMLEV,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD: PCFMLEV TOO SHORT!')
ENDIF

IF(UBOUND(PEVAPSNW,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD: PEVAPSNW TOO SHORT!')
ENDIF

IF(UBOUND(PZ0MW,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD: PZ0MW TOO SHORT!')
ENDIF

IF(UBOUND(PZ0HW,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD: PZ0HW TOO SHORT!')
ENDIF

IF(UBOUND(PZ0QW,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD: PZ0QW TOO SHORT!')
ENDIF

IF(UBOUND(PCPTSPP,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD: PCPTSPP TOO SHORT!')
ENDIF

IF(UBOUND(PQSAPP,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD: PQSAPP TOO SHORT!')
ENDIF

IF(UBOUND(PBUOMPP,1) < KLON) THEN
  CALL ABORT_SURF('SURFEXCDRIVERSAD: PBUOMPP TOO SHORT!')
ENDIF
...
IF (LHOOK) CALL DR_HOOK('SURFEXCDRIVERSAD',1,ZHOOK_HANDLE)
