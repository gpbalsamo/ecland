...
USE SURFTSTP_CTL_MOD, ONLY: SURFTSTP_CTL
!endif INTERFACE
...
REAL(KIND=JPRB)   ,INTENT(OUT)   :: PTLICEE1(KLON)
REAL(KIND=JPRB)   ,INTENT(OUT)   :: PTLMNWE1(KLON)
REAL(KIND=JPRB)   ,INTENT(OUT)   :: PTLWMLE1(KLON)
REAL(KIND=JPRB)   ,INTENT(OUT)   :: PTLBOTE1(KLON)
REAL(KIND=JPRB)   ,INTENT(OUT)   :: PTLSFE1(KLON)
REAL(KIND=JPRB)   ,INTENT(OUT)   :: PHLICEE1(KLON)
REAL(KIND=JPRB)   ,INTENT(OUT)   :: PHLMLE1(KLON)
REAL(KIND=JPRB)   ,INTENT(OUT)   :: PZO(KLON,KLEVO+1)
REAL(KIND=JPRB)   ,INTENT(OUT)   :: PHO(KLON,KLEVO+1)
REAL(KIND=JPRB)   ,INTENT(OUT)   :: PHO_INV(KLON,KLEVO+1)
...
CALL SURFTSTP_CTL(KIDIA , KFDIA , KLON  , KLEVS , KCWS, KTILES,& 
 ...
 & PWSEMEAN,PWSFMEAN,&
 & PSSDP2, PSSDP3,&
 & YDSURF%YCST   ,YDSURF%YEXC   ,YDSURF%YSOIL  ,YDSURF%YVEG   ,&
 & YDSURF%YFLAKE ,YDSURF%YURB   ,YDSURF%YAGS   ,YDSURF%YMLM   ,YDSURF%YOCEAN_ML,&
 & LNEMOICETHK, PTHKICE,&
!-DIAGNOSTICS OUTPUT
 & PTSDFL  , PROFD , PROFS, PIRFL,&
 & PWFSD   , PMELT , PFWEV, PENES,&
