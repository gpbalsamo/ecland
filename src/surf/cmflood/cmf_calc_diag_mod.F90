...
!$OMP PARALLEL DO PRIVATE(IPTH,ILEV)
DO ILEV=1, NPTHLEV
  DO IPTH=1, NPTHOUT
    D1PTHFLW_aAVG(IPTH,ILEV) = 0._JPRB
  END DO
END DO
!$OMP END PARALLEL DO
!$OMP PARALLEL DO PRIVATE(IPTH)
DO IPTH=1, NPTHOUT
...
DO ILEV=1, NPTHLEV
  DO IPTH=1, NPTHOUT
    D1PTHFLW_aAVG(IPTH,ILEV)=D1PTHFLW_aAVG(IPTH,ILEV)+D1PTHFLW(IPTH,ILEV)*DT
  END DO
END DO
!$OMP END PARALLEL DO
...
DO ILEV=1, NPTHLEV
  DO IPTH=1, NPTHOUT
    D1PTHFLW_oAVG(IPTH,ILEV) = 0._JPRB
  END DO
END DO
!$OMP END PARALLEL DO
...
DO ILEV=1, NPTHLEV
  DO IPTH=1, NPTHOUT
    D1PTHFLW_oAVG(IPTH,ILEV)=D1PTHFLW_oAVG(IPTH,ILEV)+D1PTHFLW_aAVG(IPTH,ILEV)*DT
  END DO
END DO
!$OMP END PARALLEL DO
...
DO ILEV=1, NPTHLEV
  DO IPTH=1, NPTHOUT
    D1PTHFLW_oAVG(IPTH,ILEV) = D1PTHFLW_oAVG(IPTH,ILEV) / REAL(NADD_out,KIND=JPRB)
  END DO
END DO
!$OMP END PARALLEL DO
