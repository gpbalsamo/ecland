...
DO JL=KIDIA,KFDIA
  ...
  LDLAKE(JL)= (LEFLAKE .AND. LDLAND(JL)).OR.(LEFLAKE .AND. (PCLAKE(JL) >= (1.0_JPRB-PLSM(JL)/2.0_JPRB)))  !all land points and resolved lakes are going in the lake calculations
