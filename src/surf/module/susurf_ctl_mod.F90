...
SUBROUTINE SUSURF_CTL(KSW,KCSS,KCWS,KCSNEC,KSIL,KCOM,KTILES,KTSW,KLWEMISS,&
 ...
 & LD_LLCCNL,LD_LLCCNO,LD_LEVGEN,LD_LESSRO,LD_LEIRRIGATION,LD_LELAIV,&
...
!      LD_LEIRRIGATION : .T. IF THE IRRIGATION IS ACTIVATED
...
IF(PRESENT(PRCIMIN)) THEN
  CALL SUSSOIL(PTHRFRTI,LD_LEVGEN,LD_LESSRO,LD_LEIRRIGATION,LD_LESN09,LD_LESNML,LD_LESNICE,PNSNMLWS,&
