...
TYPE :: TESURF
   ...
   ! --------------------------------------------------
    ...
    LOGICAL         :: LEWPFLOOR
    LOGICAL         :: LEFRZFLOOR
    LOGICAL         :: LEUNIFORMROOT
    LOGICAL         :: LEBEDROCKLIM
    LOGICAL         :: LEGWRECHARGE
    REAL(KIND=JPRB) :: RWTDRECHARGE
    LOGICAL         :: LEFROZENSOILFIX
    ...
    REAL(KIND=JPRB) :: RPHI_T_PR0_1
    REAL(KIND=JPRB) :: RPHI_T_PR0_2
    REAL(KIND=JPRB) :: RC_TT_1
    REAL(KIND=JPRB) :: RC_TT_2
    REAL(KIND=JPRB) :: RC_B1
    REAL(KIND=JPRB) :: RC_B2
    REAL(KIND=JPRD) :: RPHI_BOTSED_PR0
    ...
    REAL(KIND=JPRD) :: RDEPTH_W_MIX_IW
    REAL(KIND=JPRD) :: TMNW_NDG_TIMESCL
    REAL(KIND=JPRD) :: TMNW_NDG_RDSCL
    REAL(KIND=JPRD) :: RDEPTH_BOTSED
    LOGICAL         :: LFLAKE_BOTSED
